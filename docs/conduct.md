...
Dieser Code of Conduct basiert unverändert auf dem "Berlin Code of Conduct" (Version vom 15.12.2019). Beide Code of Conducts stehen unter der [Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)](https://creativecommons.org/licenses/by-sa/4.0/) Lizenz. Sie basieren auf dem [pdx.rb Code of Conduct](https://pdxruby.org/CONDUCT).
